...
| Skill | Purpose | Risk | Last reviewed |
|-------|---------|------|---------------|
| add-feature-flag | Add a Warp `FeatureFlag` and gate code | L2 | 2026-08-14 |
| add-telemetry | Instrument Warp telemetry events | L2 | 2026-08-14 |
| changelog-draft | Draft changelog from merged PRs | L2 | 2026-08-14 |
| classify-changelog-pr | Classify unmarked PRs for changelog | L1 | 2026-08-14 |
| cross-platform-cloud-verification | Pick OS/arch runners for verification | L2 | 2026-08-14 |
| dedupe-issue-local | Warp-specific issue dedupe | L2 | 2026-08-14 |
| gui-create-launch-modal | One-time GUI launch modal | L2 | 2026-08-14 |
| gui-integration-test | WarpUI integration tests | L2 | 2026-08-14 |
| gui-onboarding-verification-skill | Cloud Linux onboarding screenshots | L2 | 2026-08-14 |
| gui-reproduce-bug-report-local | Logged-out GUI repro | L2 | 2026-08-14 |
| gui-settings-ui | Settings page widgets and search | L2 | 2026-08-14 |
| gui-ui-guidelines | GUI WarpUI guidelines | L1 | 2026-08-14 |
| logging-and-error-reporting | log vs Sentry reporting | L1 | 2026-08-14 |
...
| tui-verify-change | Run and read the TUI screen | L2 | 2026-08-14 |
