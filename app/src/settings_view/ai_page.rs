...
impl SettingsWidget for GlobalAIWidget {
    ...
    fn render(
        ...
        // Synth Warp is local-first: always show the AI toggle, including without a Warp account.
        row.add_child(
            Container::new(
                ui_builder
...
impl SettingsWidget for UsageWidget {
    ...
    fn render(
        ...
        // Synth Warp is commercial-free: omit hosted upgrade CTAs from AI usage.
        Flex::column()
            .with_children([
