...
pub fn init(app: &mut AppContext) {
    ...
    // Synth Warp is local-first: do not register Warp's hosted changelog in the
    // command palette. The update toast can still deep-link if a changelog is local.
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About Synth Warp"),
