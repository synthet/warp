...
This repository's daily queue is **GitHub issues** plus existing spec trees (`specs/`,
`.agents/specs/`, `agents/specs/`). Do not treat [`.agent/backlog/items.md`](../../.agent/backlog/items.md)
as the source of work. `/task-claim` is optional.
